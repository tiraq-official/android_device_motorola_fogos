...
# Git clones
clone_if_missing "https://github.com/tiraq-official/android_device_motorola_fogos.git" "axion" "device/motorola/fogos"
clone_if_missing "https://github.com/tiraq-official/android_device_motorola_sm6375-common.git" "axion" "device/motorola/sm6375-common"
