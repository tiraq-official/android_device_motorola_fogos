...
# Git clones
clone_if_missing "https://github.com/tiraq-official/android_device_motorola_fogos.git" "shinkai-project" "device/motorola/fogos"
...
clone_if_missing "https://github.com/tiraq-official/hardware_dolby.git" "16" "hardware/dolby"
